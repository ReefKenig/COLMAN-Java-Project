...
public class MainTrain2 {
	...
	public static void main(String[] args) {
		...
		MyGenericMailBox a1=new MyGenericMailBox(1, msg->{
			MailBox a2=MailBox.get(2);
			MailBox a3=MailBox.get(3);
		...
		MyGenericMailBox a2=new MyGenericMailBox(2, msg->{
		...
		MyGenericMailBox a3=new MyGenericMailBox(3, msg->sb.append(msg));
